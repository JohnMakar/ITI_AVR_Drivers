...
void HFAN_voidFlip(u8 Copy_u8Fan)
{
	switch(Copy_u8Fan)
	{
	case FAN_ONE:   MDIO_u8TOGGPin(FAN_ONE_PORT,FAN_ONE_PIN);     break;
	case FAN_TWO:   MDIO_u8TOGGPin(FAN_TWO_PORT,FAN_TWO_PIN);     break;
	case FAN_THREE: MDIO_u8TOGGPin(FAN_THREE_PORT,FAN_THREE_PIN); break;
	default:                                                            break;
	}
