...
void HLED_void_LEDFlip(u8 Copy_u8LED)
{
	switch(Copy_u8LED)
	{
	case GRN_LED: MDIO_u8TOGGPin(LED_GRN_PORT,LED_GRN_PIN); break;
	case BLU_LED: MDIO_u8TOGGPin(LED_BLU_PORT,LED_BLU_PIN); break;
	case RED_LED: MDIO_u8TOGGPin(LED_RED_PORT,LED_RED_PIN); break;
	default:                                              break;
	}
}
